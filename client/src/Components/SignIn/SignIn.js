      ...
      <div className="parent-sign-in">
        <section className="sign-in-page">
          ...
          <p className="sign-in-brief">
            ...
            account. Sign in to enjoy the ability to purchase any delectable
            dish you desire, while also gaining the advantage of effortlessly
            saving your favorite meals to a dedicated 'Favorites' section for
